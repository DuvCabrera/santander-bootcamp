...
import com.duv.aplicationcontentprovider.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import com.duv.aplicationcontentprovider.database.NotesDatabaseHelper.Companion.TITLE_NOTES
import com.duv.aplicationcontentprovider.database.NotesProvider.Companion.URI_NOTES
...
class NotesDetailFragment: DialogFragment(), DialogInterface.OnClickListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        if  (arguments != null && arguments?.getLong(EXTRA_ID) != 0L) {
            ...
            val cursor =
                activity?.contentResolver?.query(uri, null, null, null)
