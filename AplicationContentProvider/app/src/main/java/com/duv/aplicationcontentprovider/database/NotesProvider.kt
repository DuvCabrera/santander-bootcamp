...
import com.duv.aplicationcontentprovider.database.NotesDatabaseHelper.Companion.TABLE_NOTES
...
class NotesProvider : ContentProvider() {
    ...
    companion object {
        const val AUTHORITY = "com.duv.aplicationcontentprovider.provider"
